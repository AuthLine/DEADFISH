...
class epibot_websocket_client_ftx extends epibot_websocket.client {
  constructor (conf = {}) {
...
module.exports = class epibot_websocket_ftx extends epibot_websocket.base {

  constructor (stub, account) {
    super (stub, account);
    this.ticker = {};
    this.ws = new epibot_websocket_client_ftx ({
      exchange: 'ftx',
      stub: stub,
      apikey: this.apikey,
      secret: this.secret,
