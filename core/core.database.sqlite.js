...
module.exports = class epibot_database_sqlite_module extends epibot_database_base_module {
    ...
    constructor() {
        ...
        if (dbcfgjson.length > 0) {
            ...
            var dbfile = (dbcfg.hasOwnProperty('file') ? dbcfg.file : '/usr/local/epibot-js/database/database.db').toLowerCase();
        }
